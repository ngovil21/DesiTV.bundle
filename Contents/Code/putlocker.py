...
ReallyFuzzy/LetMeWatchThis.bundle

LetMeWatchThis.bundle/Contents/Services/URL/PutLocker/ServiceCode.pys
Yoyo on Jan 27 Normalise EOL.

0 contributors
259 lines (192 sloc) 7.384 kB
...
def PlayVideo(url):
	...
	# Might as well set a sensible user agent strSing.
